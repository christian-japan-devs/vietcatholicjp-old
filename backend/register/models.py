...
class District(models.Model):
    district_name = models.CharField(
        _('District'), help_text=_('District name'), max_length=50)
...
class Station(models.Model):
    station_name = models.CharField(
        _('Station'), help_text=_('Station name'), max_length=50)
    station_code = models.CharField(
        _('Postal code'), help_text=_('Postal code'), max_length=12)
    station_en_name = models.CharField(
        _('International Name'), help_text=_('International Name'), max_length=50)
    district = models.ForeignKey(
        District, on_delete=models.CASCADE, default=None, related_name='district')

    def __str__(self):
        return self.station_en_name
...
class Church(models.Model):
    ...
    church_country = models.ForeignKey(
        ...
        related_name='church_country_reversed'
    )
    church_province = models.ForeignKey(
        Province,
        verbose_name=_('Province'),
        blank=True,
        null=True,
        related_name='church_province_reversed',
        on_delete=models.CASCADE
    )
    church_district = models.ForeignKey(
        District,
        verbose_name=_('District'),
        blank=True,
        null=True,
        related_name='church_district_reversed',
        on_delete=models.CASCADE)
    church_station = models.ForeignKey(
        Station,
        verbose_name=_('Station'),
        blank=True,
        null=True,
        related_name='church_station_reversed',
        on_delete=models.CASCADE)
